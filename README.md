...
Replace the "1" values with you solutions. Note, do not change the column titles, nor the number of columns or rows of the solution file. Any changes to the file format will prevent your solution from being scored. The file is a comma delimited file.
